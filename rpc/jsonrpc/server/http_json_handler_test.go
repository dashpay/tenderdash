...
func testMux() *http.ServeMux {
	...
	funcMap := map[string]*RPCFunc{
		"c":     NewRPCFunc(func(_ context.Context, _ *testArgs) (string, error) { return "foo", nil }),
		"block": NewRPCFunc(func(_ context.Context, _ *blockArgs) (string, error) { return "block", nil }),
	}
