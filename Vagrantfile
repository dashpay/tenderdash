...
Vagrant.configure("2") do |config|
  ...
  config.vm.provision "shell", inline: <<-SHELL
    ...
    echo 'cd go/src/github.com/dashevo/tendermint' >> /home/vagrant/.bash_profile

    mkdir -p /home/vagrant/go/bin
    mkdir -p /home/vagrant/go/src/github.com/dashevo
    ln -s /vagrant /home/vagrant/go/src/github.com/dashevo/tendermint
    ...
    su - vagrant -c 'cd /home/vagrant/go/src/github.com/dashevo/tendermint && make tools'
  SHELL
end
