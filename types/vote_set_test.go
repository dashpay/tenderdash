...
func TestVoteSet_Conflicts(t *testing.T) {
	...
	err = voteSet.SetPeerMaj23("peerA", BlockID{blockHash1, PartSetHeader{}}, height, round)
	require.NoError(t, err)
	...
	err = voteSet.SetPeerMaj23("peerA", BlockID{blockHash2, PartSetHeader{}}, height, round)
	require.Error(t, err)
	...
	err = voteSet.SetPeerMaj23("peerB", BlockID{blockHash1, PartSetHeader{}}, height, round)
	require.NoError(t, err)
