...
func (_c *PrivValidator_ExtractIntoValidator_Call) Run(run func(ctx context.Context, quorumHash bytes.HexBytes)) *PrivValidator_ExtractIntoValidator_Call {
...
func (_c *PrivValidator_ExtractIntoValidator_Call) RunAndReturn(run func(context.Context, bytes.HexBytes) *types.Validator) *PrivValidator_ExtractIntoValidator_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *PrivValidator_GetFirstQuorumHash_Call) Return(_a0 bytes.HexBytes, _a1 error) *PrivValidator_GetFirstQuorumHash_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *PrivValidator_GetFirstQuorumHash_Call) RunAndReturn(run func(context.Context) (bytes.HexBytes, error)) *PrivValidator_GetFirstQuorumHash_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *PrivValidator_GetHeight_Call) Run(run func(ctx context.Context, quorumHash bytes.HexBytes)) *PrivValidator_GetHeight_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(bytes.HexBytes))
	})
	return _c
...
func (_c *PrivValidator_GetHeight_Call) RunAndReturn(run func(context.Context, bytes.HexBytes) (int64, error)) *PrivValidator_GetHeight_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *PrivValidator_GetPrivateKey_Call) Run(run func(ctx context.Context, quorumHash bytes.HexBytes)) *PrivValidator_GetPrivateKey_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(bytes.HexBytes))
	})
	return _c
...
func (_c *PrivValidator_GetPrivateKey_Call) RunAndReturn(run func(context.Context, bytes.HexBytes) (crypto.PrivKey, error)) *PrivValidator_GetPrivateKey_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *PrivValidator_GetProTxHash_Call) Return(_a0 bytes.HexBytes, _a1 error) *PrivValidator_GetProTxHash_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *PrivValidator_GetProTxHash_Call) RunAndReturn(run func(context.Context) (bytes.HexBytes, error)) *PrivValidator_GetProTxHash_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *PrivValidator_GetPubKey_Call) Run(run func(ctx context.Context, quorumHash bytes.HexBytes)) *PrivValidator_GetPubKey_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(bytes.HexBytes))
	})
	return _c
...
func (_c *PrivValidator_GetPubKey_Call) RunAndReturn(run func(context.Context, bytes.HexBytes) (crypto.PubKey, error)) *PrivValidator_GetPubKey_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *PrivValidator_GetThresholdPublicKey_Call) Run(run func(ctx context.Context, quorumHash bytes.HexBytes)) *PrivValidator_GetThresholdPublicKey_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(bytes.HexBytes))
	})
	return _c
...
func (_c *PrivValidator_GetThresholdPublicKey_Call) RunAndReturn(run func(context.Context, bytes.HexBytes) (crypto.PubKey, error)) *PrivValidator_GetThresholdPublicKey_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *PrivValidator_SignProposal_Call) Run(run func(ctx context.Context, chainID string, quorumType btcjson.LLMQType, quorumHash bytes.HexBytes, proposal *tenderminttypes.Proposal)) *PrivValidator_SignProposal_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(string), args[2].(btcjson.LLMQType), args[3].(bytes.HexBytes), args[4].(*tenderminttypes.Proposal))
	})
	return _c
}
...
func (_c *PrivValidator_SignProposal_Call) RunAndReturn(run func(context.Context, string, btcjson.LLMQType, bytes.HexBytes, *tenderminttypes.Proposal) (bytes.HexBytes, error)) *PrivValidator_SignProposal_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *PrivValidator_SignVote_Call) Run(run func(ctx context.Context, chainID string, quorumType btcjson.LLMQType, quorumHash bytes.HexBytes, vote *tenderminttypes.Vote, logger log.Logger)) *PrivValidator_SignVote_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(string), args[2].(btcjson.LLMQType), args[3].(bytes.HexBytes), args[4].(*tenderminttypes.Vote), args[5].(log.Logger))
	})
	return _c
}
...
func (_c *PrivValidator_SignVote_Call) RunAndReturn(run func(context.Context, string, btcjson.LLMQType, bytes.HexBytes, *tenderminttypes.Vote, log.Logger) error) *PrivValidator_SignVote_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *PrivValidator_UpdatePrivateKey_Call) Run(run func(ctx context.Context, privateKey crypto.PrivKey, quorumHash bytes.HexBytes, thresholdPublicKey crypto.PubKey, height int64)) *PrivValidator_UpdatePrivateKey_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(crypto.PrivKey), args[2].(bytes.HexBytes), args[3].(crypto.PubKey), args[4].(int64))
	})
	return _c
}
...
func (_c *PrivValidator_UpdatePrivateKey_Call) RunAndReturn(run func(context.Context, crypto.PrivKey, bytes.HexBytes, crypto.PubKey, int64)) *PrivValidator_UpdatePrivateKey_Call {
	_c.Call.Return(run)
	return _c
}
