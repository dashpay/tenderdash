...
1. Make an issue with the proposed change.
   - Within the issue members, from the Tendermint team will leave comments. If there is no consensus on the change an RFC (Request For Change) may be requested.
