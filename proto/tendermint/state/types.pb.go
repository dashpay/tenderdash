...
type State struct {
	...
	InitialCoreChainLockedHeight uint32               `protobuf:"varint,100,opt,name=initial_core_chain_locked_height,json=initialCoreChainLockedHeight,proto3" json:"initial_core_chain_locked_height,omitempty"`
	LastCoreChainLock            types1.CoreChainLock `protobuf:"bytes,101,opt,name=last_core_chain_lock,json=lastCoreChainLock,proto3" json:"last_core_chain_lock"`
	NextCoreChainLock            types1.CoreChainLock `protobuf:"bytes,102,opt,name=next_core_chain_lock,json=nextCoreChainLock,proto3" json:"next_core_chain_lock"`
...
func (m *State) GetInitialCoreChainLockedHeight() uint32 {
	if m != nil {
		return m.InitialCoreChainLockedHeight
	}
	return 0
}
...
var fileDescriptor_ccfacf933f22bf93 = []byte{
	...
	,
}
...
func (m *State) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	i--
	dAtA[i] = 0xaa
	if m.InitialCoreChainLockedHeight != 0 {
		i = encodeVarintTypes(dAtA, i, uint64(m.InitialCoreChainLockedHeight))
		i--
		dAtA[i] = 0x6
		i--
		dAtA[i] = 0xa0
...
func (m *State) Size() (n int) {
	...
	if m.InitialCoreChainLockedHeight != 0 {
		n += 2 + sovTypes(uint64(m.InitialCoreChainLockedHeight))
	}
...
func (m *State) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 100:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field InitialCoreChainLockedHeight", wireType)
			}
			m.InitialCoreChainLockedHeight = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowTypes
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.InitialCoreChainLockedHeight |= uint32(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
