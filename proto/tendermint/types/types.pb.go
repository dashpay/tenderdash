...
// StateID contains information for light clients (like mobile apps) that is
// essential to verify application state.
// Note that the serialization mechanism of StateID for cryptographic purposes
// uses simple, fixed-length algorithm instead of protobuf for better
// interoperability.
//
type StateID struct {
	// version represents version of the ABCI application (equals to Header.version.app).
	// Encoded as 16-bit little-endian unsigned int (on 2 bytes)
	Version uint32 `protobuf:"fixed32,1,opt,name=version,proto3" json:"version,omitempty"`
	// height of the block (equals to Header.height). Encoded as unsigned 64-bit int, on 8 bytes.
	Height uint64 `protobuf:"fixed64,2,opt,name=height,proto3" json:"height,omitempty"`
	// app_hash represents Header.app_hash .  Encoded as 32 bytes.
	...
	// timestamp of the block (equals to Header.time). TODO: Describe encoding
...
func (m *StateID) GetVersion() uint32 {
	if m != nil {
		return m.Version
	}
	return 0
...
func (m *StateID) GetTime() *types.Timestamp {
	if m != nil {
		return m.Time
	}
	return nil
...
var fileDescriptor_d3a6e55e2345de56 = []byte{
	...
	,
}
...
func (m *StateID) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.Version = uint32(encoding_binary.LittleEndian.Uint32(dAtA[iNdEx:]))
			iNdEx += 4
		case 2:
			if wireType != 1 {
