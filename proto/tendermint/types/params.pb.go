...
const (
	...
	// CONSENSUS_VERSION_2 changes the way consensus parameters are hashed into the block header.
	// It hashes the entire ConsensusParams instead of just a subset.
	VersionParams_CONSENSUS_VERSION_2 VersionParams_ConsensusVersion = 2
)

var VersionParams_ConsensusVersion_name = map[int32]string{
	0: "CONSENSUS_VERSION_0",
	1: "CONSENSUS_VERSION_1",
	2: "CONSENSUS_VERSION_2",
}

var VersionParams_ConsensusVersion_value = map[string]int32{
	"CONSENSUS_VERSION_0": 0,
	"CONSENSUS_VERSION_1": 1,
	"CONSENSUS_VERSION_2": 2,
}

func (x VersionParams_ConsensusVersion) String() string {
	return proto.EnumName(VersionParams_ConsensusVersion_name, int32(x))
}

func (VersionParams_ConsensusVersion) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_e12598271a686f57, []int{4, 0}
}
...
type ValidatorParams struct {
	...
	// Types that are valid to be assigned to XVotingPowerThreshold:
	//	*ValidatorParams_VotingPowerThreshold
	XVotingPowerThreshold isValidatorParams_XVotingPowerThreshold `protobuf_oneof:"_voting_power_threshold"`
}
...
type isValidatorParams_XVotingPowerThreshold interface {
	isValidatorParams_XVotingPowerThreshold()
	Equal(interface{}) bool
	MarshalTo([]byte) (int, error)
	Size() int
}

type ValidatorParams_VotingPowerThreshold struct {
	VotingPowerThreshold uint64 `protobuf:"varint,2,opt,name=voting_power_threshold,json=votingPowerThreshold,proto3,oneof" json:"voting_power_threshold,omitempty"`
}

func (*ValidatorParams_VotingPowerThreshold) isValidatorParams_XVotingPowerThreshold() {}

func (m *ValidatorParams) GetXVotingPowerThreshold() isValidatorParams_XVotingPowerThreshold {
	if m != nil {
		return m.XVotingPowerThreshold
	}
	return nil
}
...
func (m *ValidatorParams) GetVotingPowerThreshold() uint64 {
	if x, ok := m.GetXVotingPowerThreshold().(*ValidatorParams_VotingPowerThreshold); ok {
		return x.VotingPowerThreshold
	}
	return 0
}

// XXX_OneofWrappers is for the internal use of the proto package.
func (*ValidatorParams) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		(*ValidatorParams_VotingPowerThreshold)(nil),
	}
}
...
func (m *VersionParams) GetConsensusVersion() VersionParams_ConsensusVersion {
	if m != nil {
		return m.ConsensusVersion
	}
	return VersionParams_CONSENSUS_VERSION_0
}
...
type HashedParams struct {
	...
	ConsensusVersion int32 `protobuf:"varint,3,opt,name=consensus_version,json=consensusVersion,proto3" json:"consensus_version,omitempty"`
}
...
func (m *HashedParams) GetConsensusVersion() int32 {
	if m != nil {
		return m.ConsensusVersion
	}
	return 0
...
type ABCIParams struct {
	...
	RecheckTx bool `protobuf:"varint,1,opt,name=recheck_tx,json=recheckTx,proto3" json:"recheck_tx,omitempty"`
}
...
func init() {
	proto.RegisterEnum("tendermint.types.VersionParams_ConsensusVersion", VersionParams_ConsensusVersion_name, VersionParams_ConsensusVersion_value)
...
var fileDescriptor_e12598271a686f57 = []byte{
	...
	,
}
...
func (this *ValidatorParams) Equal(that interface{}) bool {
	...
	if that1.XVotingPowerThreshold == nil {
		if this.XVotingPowerThreshold != nil {
			return false
		}
	} else if this.XVotingPowerThreshold == nil {
		return false
	} else if !this.XVotingPowerThreshold.Equal(that1.XVotingPowerThreshold) {
		return false
	}
	return true
}
func (this *ValidatorParams_VotingPowerThreshold) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*ValidatorParams_VotingPowerThreshold)
	if !ok {
		that2, ok := that.(ValidatorParams_VotingPowerThreshold)
		if ok {
			that1 = &that2
		} else {
			return false
	...
	if this.VotingPowerThreshold != that1.VotingPowerThreshold {
		return false
	}
	return true
}
func (this *VersionParams) Equal(that interface{}) bool {
	...
	if this.ConsensusVersion != that1.ConsensusVersion {
		return false
	}
	return true
}
...
func (m *ValidatorParams) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if m.XVotingPowerThreshold != nil {
		{
			size := m.XVotingPowerThreshold.Size()
			i -= size
			if _, err := m.XVotingPowerThreshold.MarshalTo(dAtA[i:]); err != nil {
				return 0, err
			}
		}
	}
...
func (m *ValidatorParams_VotingPowerThreshold) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}
...
func (m *VersionParams) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.ConsensusVersion != 0 {
		i = encodeVarintParams(dAtA, i, uint64(m.ConsensusVersion))
		i--
		dAtA[i] = 0x10
	}
	if m.AppVersion != 0 {
...
func (m *TimeoutParams) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if m.VoteDelta != nil {
		n11, err11 := github_com_cosmos_gogoproto_types.StdDurationMarshalTo(*m.VoteDelta, dAtA[i-github_com_cosmos_gogoproto_types.SizeOfStdDuration(*m.VoteDelta):])
		if err11 != nil {
			return 0, err11
		}
		i -= n11
	...
	if m.Vote != nil {
		n12, err12 := github_com_cosmos_gogoproto_types.StdDurationMarshalTo(*m.Vote, dAtA[i-github_com_cosmos_gogoproto_types.SizeOfStdDuration(*m.Vote):])
		if err12 != nil {
			return 0, err12
		}
		i -= n12
	...
	if m.ProposeDelta != nil {
		n13, err13 := github_com_cosmos_gogoproto_types.StdDurationMarshalTo(*m.ProposeDelta, dAtA[i-github_com_cosmos_gogoproto_types.SizeOfStdDuration(*m.ProposeDelta):])
		if err13 != nil {
			return 0, err13
		}
		i -= n13
	...
	if m.Propose != nil {
		n14, err14 := github_com_cosmos_gogoproto_types.StdDurationMarshalTo(*m.Propose, dAtA[i-github_com_cosmos_gogoproto_types.SizeOfStdDuration(*m.Propose):])
		if err14 != nil {
			return 0, err14
		}
		i -= n14
...
func (m *ValidatorParams) Size() (n int) {
	...
	if m.XVotingPowerThreshold != nil {
		n += m.XVotingPowerThreshold.Size()
	}
	return n
}

func (m *ValidatorParams_VotingPowerThreshold) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	n += 1 + sovParams(uint64(m.VotingPowerThreshold))
	return n
}
func (m *VersionParams) Size() (n int) {
	...
	if m.ConsensusVersion != 0 {
		n += 1 + sovParams(uint64(m.ConsensusVersion))
	}
	return n
}
...
func (m *TimeoutParams) Size() (n int) {
	...
	_ = l
	if m.Propose != nil {
		l = github_com_cosmos_gogoproto_types.SizeOfStdDuration(*m.Propose)
		n += 1 + l + sovParams(uint64(l))
	}
	if m.ProposeDelta != nil {
		l = github_com_cosmos_gogoproto_types.SizeOfStdDuration(*m.ProposeDelta)
		n += 1 + l + sovParams(uint64(l))
	}
	if m.Vote != nil {
		l = github_com_cosmos_gogoproto_types.SizeOfStdDuration(*m.Vote)
		n += 1 + l + sovParams(uint64(l))
	}
	if m.VoteDelta != nil {
		l = github_com_cosmos_gogoproto_types.SizeOfStdDuration(*m.VoteDelta)
		n += 1 + l + sovParams(uint64(l))
	}
	return n
}
...
func (m *ValidatorParams) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			m.XVotingPowerThreshold = &ValidatorParams_VotingPowerThreshold{v}
		default:
			iNdEx = preIndex
			skippy, err := skipParams(dAtA[iNdEx:])
			if err != nil {
	...
	for iNdEx < l {
		...
		case 2:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.ConsensusVersion |= VersionParams_ConsensusVersion(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
	...
	for iNdEx < l {
		...
		case 3:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.ConsensusVersion |= int32(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *TimeoutParams) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			if err := github_com_cosmos_gogoproto_types.StdDurationUnmarshal(m.Propose, dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 2:
			...
			if err := github_com_cosmos_gogoproto_types.StdDurationUnmarshal(m.ProposeDelta, dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 3:
			...
			if err := github_com_cosmos_gogoproto_types.StdDurationUnmarshal(m.Vote, dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 4:
			...
			if err := github_com_cosmos_gogoproto_types.StdDurationUnmarshal(m.VoteDelta, dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
