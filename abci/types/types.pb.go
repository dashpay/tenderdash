...
type Snapshot struct {
	Height  uint64 `protobuf:"varint,1,opt,name=height,proto3" json:"height,omitempty"`
	Version uint32 `protobuf:"varint,2,opt,name=version,proto3" json:"version,omitempty"`
	// Types that are valid to be assigned to XChunks:
	//	*Snapshot_Chunks
	XChunks  isSnapshot_XChunks `protobuf_oneof:"_chunks"`
	Hash     []byte             `protobuf:"bytes,4,opt,name=hash,proto3" json:"hash,omitempty"`
...
type isSnapshot_XChunks interface {
	isSnapshot_XChunks()
	MarshalTo([]byte) (int, error)
	Size() int
}

type Snapshot_Chunks struct {
	Chunks uint32 `protobuf:"varint,3,opt,name=chunks,proto3,oneof" json:"chunks,omitempty"`
}

func (*Snapshot_Chunks) isSnapshot_XChunks() {}

func (m *Snapshot) GetXChunks() isSnapshot_XChunks {
	if m != nil {
		return m.XChunks
	}
	return nil
...
func (m *Snapshot) GetChunks() uint32 {
	if x, ok := m.GetXChunks().(*Snapshot_Chunks); ok {
		return x.Chunks
	}
	return 0
}
...
// XXX_OneofWrappers is for the internal use of the proto package.
func (*Snapshot) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		(*Snapshot_Chunks)(nil),
	}
}
...
var fileDescriptor_252557cfdd89a31a = []byte{
	...
	,
}
	...
	if m.XChunks != nil {
		{
			size := m.XChunks.Size()
			i -= size
			if _, err := m.XChunks.MarshalTo(dAtA[i:]); err != nil {
				return 0, err
			}
		}
	}
...
func (m *Snapshot_Chunks) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *Snapshot_Chunks) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
...
func (m *Snapshot_Chunks) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
