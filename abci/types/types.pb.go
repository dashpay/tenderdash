...
type ResponsePrepareProposal struct {
	...
	// Types that are valid to be assigned to XAppVersion:
	//
	//	*ResponsePrepareProposal_AppVersion
	XAppVersion isResponsePrepareProposal_XAppVersion `protobuf_oneof:"_app_version"`
}
...
type isResponsePrepareProposal_XAppVersion interface {
	isResponsePrepareProposal_XAppVersion()
	MarshalTo([]byte) (int, error)
	Size() int
}

type ResponsePrepareProposal_AppVersion struct {
	AppVersion uint64 `protobuf:"varint,7,opt,name=app_version,json=appVersion,proto3,oneof" json:"app_version,omitempty"`
}

func (*ResponsePrepareProposal_AppVersion) isResponsePrepareProposal_XAppVersion() {}

func (m *ResponsePrepareProposal) GetXAppVersion() isResponsePrepareProposal_XAppVersion {
	if m != nil {
		return m.XAppVersion
	}
	return nil
}
...
func (m *ResponsePrepareProposal) GetAppVersion() uint64 {
	if x, ok := m.GetXAppVersion().(*ResponsePrepareProposal_AppVersion); ok {
		return x.AppVersion
	}
	return 0
}
...
// XXX_OneofWrappers is for the internal use of the proto package.
func (*ResponsePrepareProposal) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		(*ResponsePrepareProposal_AppVersion)(nil),
	}
}
...
var fileDescriptor_252557cfdd89a31a = []byte{
	...
	,
}
...
func (m *ResponsePrepareProposal) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if m.XAppVersion != nil {
		{
			size := m.XAppVersion.Size()
			i -= size
			if _, err := m.XAppVersion.MarshalTo(dAtA[i:]); err != nil {
				return 0, err
			}
		}
	}
...
func (m *ResponsePrepareProposal_AppVersion) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ResponsePrepareProposal_AppVersion) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	i = encodeVarintTypes(dAtA, i, uint64(m.AppVersion))
	i--
	dAtA[i] = 0x38
...
func (m *ResponsePrepareProposal) Size() (n int) {
	...
	if m.XAppVersion != nil {
		n += m.XAppVersion.Size()
	}
	return n
}

func (m *ResponsePrepareProposal_AppVersion) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *ResponsePrepareProposal) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 7:
			...
			m.XAppVersion = &ResponsePrepareProposal_AppVersion{v}
		default:
			iNdEx = preIndex
			skippy, err := skipTypes(dAtA[iNdEx:])
			if err != nil {
