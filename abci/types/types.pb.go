...
type RequestVerifyVoteExtension struct {
	...
	// Types that are valid to be assigned to XSignId:
	//
	//	*RequestVerifyVoteExtension_SignId
	XSignId isRequestVerifyVoteExtension_XSignId `protobuf_oneof:"_sign_id"`
}
...
type isRequestVerifyVoteExtension_XSignId interface {
	isRequestVerifyVoteExtension_XSignId()
	MarshalTo([]byte) (int, error)
	Size() int
}

type RequestVerifyVoteExtension_SignId struct {
	SignId []byte `protobuf:"bytes,6,opt,name=sign_id,json=signId,proto3,oneof" json:"sign_id,omitempty"`
}

func (*RequestVerifyVoteExtension_SignId) isRequestVerifyVoteExtension_XSignId() {}

func (m *RequestVerifyVoteExtension) GetXSignId() isRequestVerifyVoteExtension_XSignId {
	if m != nil {
		return m.XSignId
	}
	return nil
...
func (m *RequestVerifyVoteExtension) GetSignId() []byte {
	if x, ok := m.GetXSignId().(*RequestVerifyVoteExtension_SignId); ok {
		return x.SignId
	}
	return nil
}
...
// XXX_OneofWrappers is for the internal use of the proto package.
func (*RequestVerifyVoteExtension) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		(*RequestVerifyVoteExtension_SignId)(nil),
	}
}
...
var fileDescriptor_252557cfdd89a31a = []byte{
	...
	,
}
	...
	if m.XSignId != nil {
		{
			size := m.XSignId.Size()
			i -= size
			if _, err := m.XSignId.MarshalTo(dAtA[i:]); err != nil {
				return 0, err
			}
		}
	}
...
func (m *RequestVerifyVoteExtension_SignId) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *RequestVerifyVoteExtension_SignId) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.SignId != nil {
		i -= len(m.SignId)
...
func (m *RequestVerifyVoteExtension_SignId) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *RequestVerifyVoteExtension) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 6:
			...
			m.XSignId = &RequestVerifyVoteExtension_SignId{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipTypes(dAtA[iNdEx:])
