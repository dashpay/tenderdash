...
type ResponseFinalizeBlock struct {
	...
	// When `true`, this node does not wait for transactions (`create-empty-blocks-interval`)
	// before proposing round 0 of the next height: the application has block-driven work
	// pending, for example withdrawal transactions to sign. A hint for the local node only,
	// consumed once; a node that restarts in between falls back to the configured wait.
	// Defaults to `false`.
	ProposeNextBlockImmediately bool `protobuf:"varint,3,opt,name=propose_next_block_immediately,json=proposeNextBlockImmediately,proto3" json:"propose_next_block_immediately,omitempty"`
}
...
func (m *ResponseFinalizeBlock) GetProposeNextBlockImmediately() bool {
	if m != nil {
		return m.ProposeNextBlockImmediately
	}
	return false
}
...
var fileDescriptor_252557cfdd89a31a = []byte{
	...
	,
	...
	,
}
...
func (m *ResponseFinalizeBlock) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if m.ProposeNextBlockImmediately {
		i--
		if m.ProposeNextBlockImmediately {
			dAtA[i] = 1
		} else {
...
func (m *ResponseFinalizeBlock) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field ProposeNextBlockImmediately", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.ProposeNextBlockImmediately = bool(v != 0)
		default:
			iNdEx = preIndex
			skippy, err := skipTypes(dAtA[iNdEx:])
			if err != nil {
