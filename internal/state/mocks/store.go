...
import (
	...
	validatorscoring "github.com/dashpay/tenderdash/internal/features/validatorscoring"
)
...
func (_m *Store) LoadValidators(_a0 int64, _a1 validatorscoring.BlockCommitStore) (*types.ValidatorSet, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(int64, validatorscoring.BlockCommitStore) (*types.ValidatorSet, error)); ok {
		return rf(_a0, _a1)
	}
	if rf, ok := ret.Get(0).(func(int64, validatorscoring.BlockCommitStore) *types.ValidatorSet); ok {
		r0 = rf(_a0, _a1)
	} else {
		if ret.Get(0) != nil {
	...
	if rf, ok := ret.Get(1).(func(int64, validatorscoring.BlockCommitStore) error); ok {
		r1 = rf(_a0, _a1)
	} else {
		r1 = ret.Error(1)
	}
