...
export CGO_LDFLAGS="-L${GOPATH}/src/github.com/xdustinface/bls-signatures/build"
export CGO_CXXFLAGS="-I${GOPATH}/src/github.com/xdustinface/bls-signatures/src -I${GOPATH}/src/github.com/xdustinface/bls-signatures/contrib/relic/include -I${GOPATH}/src/github.com/xdustinface/bls-signatures/build/contrib/relic/include"
