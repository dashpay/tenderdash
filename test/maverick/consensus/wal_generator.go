...
func WALGenerateNBlocks(t *testing.T, wr io.Writer, numBlocks int) (err error) {
	...
	blockExec := sm.NewBlockExecutor(stateStore, log.TestingLogger(), proxyApp.Consensus(), proxyApp.Query(), mempool, evpool, nil, 0, sm.BlockExecutorWithAppHashSize(config.Consensus.AppHashSize))
